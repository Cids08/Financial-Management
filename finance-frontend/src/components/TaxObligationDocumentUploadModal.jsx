// src/components/TaxObligationDocumentUploadModal.jsx
...
/**
 * Modal for attaching a supporting document (BIR receipt, official
 * receipt scan, etc.) to a tax obligation.
 *
 * Props:
...
export default function TaxObligationDocumentUploadModal({ open, onClose, obligation, onUpload }) {
  ...
  const handleSubmit = async () => {
    ...
    if (result?.success) {
      ...
      setError(result?.message || 'Failed to attach the document. Please try again.')
    }
  }
